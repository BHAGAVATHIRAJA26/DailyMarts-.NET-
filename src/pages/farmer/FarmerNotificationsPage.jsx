      ...
      <div className="page-container max-w-2xl">
        ...
        {loading ? (
          ...
          <div className="empty-state card p-8 text-center">
            ...
            <div className="empty-state-title font-bold text-xl mb-1">No Notifications</div>
            <div className="empty-state-desc text-muted">Customer order alerts, payments, and notifications will appear here.</div>
          </div>
        ) : (
          <div className="flex flex-col gap-3">
            {notifs.map((n) => (
              <div key={n._id || n.id} className={`card p-4 flex items-start gap-4 ${!n.isRead && !n.read ? 'border-green bg-green-50' : ''}`}>
